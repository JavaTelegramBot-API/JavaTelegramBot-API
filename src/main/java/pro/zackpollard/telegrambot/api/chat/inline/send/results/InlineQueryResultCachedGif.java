...
public class InlineQueryResultCachedGif implements InlineQueryResultCached {
     ...
     *
     * @return The ID for the cached gif file on the telegram servers
     */
    @NonNull
    ...
    public static class InlineQueryResultCachedGifBuilder {
         ...
         *
         * @param gifFileId The ID of the cached gif file you want to use from the telegram servers
         *
         * @return The builder object
         */
         ...
         * @return The builder object
         */
        public InlineQueryResultCachedGifBuilder replyMarkup(InlineReplyMarkup replyMarkup) {
         ...
         *
         * @return An InlineQueryResultCachedGif object based on the previously provided values
         */
